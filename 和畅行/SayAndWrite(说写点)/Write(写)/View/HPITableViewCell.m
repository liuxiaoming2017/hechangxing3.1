...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
      if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
          self.titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(25, 0, (ScreenWidth -20)/2 - 35, 46)];
          self.titleLabel.font = [UIFont systemFontOfSize:14];
          self.titleLabel.numberOfLines = 2;
          [self addSubview:self.titleLabel];
          self.stateLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.titleLabel.right, 0, 80, 46)];
          self.stateLabel.font = [UIFont systemFontOfSize:14];
          [self addSubview:self.stateLabel];
          self.deletButton = [UIButton buttonWithType:(UIButtonTypeCustom)];
          self.deletButton.frame = CGRectMake(ScreenWidth - 80, 12, 20, 22);
          ...
          UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(0, 45, ScreenWidth - 20, 1)];
