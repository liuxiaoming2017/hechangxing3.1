...
/*
 ...
 @property (weak, nonatomic) IBOutlet UILabel *threeTLabel;*/
    ...
    self.starLbale.font = [UIFont systemFontOfSize:14];
    self.touchLabel.font = [UIFont systemFontOfSize:11];
    self.one3Label.font = [UIFont systemFontOfSize:11];
    self.twoLabel.font = [UIFont systemFontOfSize:14];
    self.twoTLabel.font = [UIFont systemFontOfSize:11];
    self.threeLabel.font = [UIFont systemFontOfSize:11];
    self.threeTLabel.font = [UIFont systemFontOfSize:11];
}
...
//    }
    ...
    [label setFrame:CGRectMake(SCREEN_WID+Adapter(6), Adapter(6), SCREEN_WID-2*Adapter(6), hei)];
    label.font = font;
    label.text = str;
    ...
    hei = [str boundingRectWithSize:CGSizeMake(self.view.frame.size.width-2*Adapter(6), MAXFLOAT) options:(NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading) attributes:[NSDictionary dictionaryWithObjectsAndKeys:font,NSFontAttributeName, nil] context:nil].size.height;
    [label2 setFrame:CGRectMake(SCREEN_WID*2+Adapter(6), Adapter(6), SCREEN_WID-2*Adapter(6), hei)];
    label2.font = font;
    label2.text = str;
