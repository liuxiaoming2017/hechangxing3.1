...
-(void)myselfStyle {
    ...
    self.layer.cornerRadius = 4.0;
    self.layer.masksToBounds = YES;
    self.layer.borderColor = [RGBA(0x9f, 0xa0, 0xa0, 1) CGColor];
    [self setAdjustsImageWhenHighlighted:NO];
    //    [self.titleLabel setFont:[UIFont fontWithName:@"FontAwesome" size:self.titleLabel.font.pointSize]];
}
...
-(void)myselfStyle2 {
    ...
    self.layer.cornerRadius = 4.0;
    self.layer.masksToBounds = YES;
    self.layer.borderColor = (__bridge CGColorRef)([UIColor whiteColor]);
    [self setAdjustsImageWhenHighlighted:NO];
}
...
- (void)normalColor:(UIColor*)nc pressedColor:(UIColor*)pc {
    ...
    [self setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    //    [self.titleLabel setFont:[UIFont fontWithName:@"FontAwesome" size:self.titleLabel.font.pointSize]];
    self.layer.borderColor = [BTN_BORDER_COLOR CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:nc] forState:UIControlStateNormal];
    [self setBackgroundImage:[self buttonImageFromColor:pc] forState:UIControlStateHighlighted];
}
...
- (void)withBorder:(int)val normalColor:(UIColor*)nc pressedColor:(UIColor*)pc{
    ...
    self.layer.masksToBounds = YES;
    [self setAdjustsImageWhenHighlighted:NO];
    [self setTitleColor:RGBA(0x89, 0x89, 0x89, 1) forState:UIControlStateNormal];
    //    [self.titleLabel setFont:[UIFont fontWithName:@"FontAwesome" size:self.titleLabel.font.pointSize]];
    self.layer.borderColor = [BTN_BORDER_COLOR CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:nc] forState:UIControlStateNormal];
    [self setBackgroundImage:[self buttonImageFromColor:pc] forState:UIControlStateHighlighted];
...
- (void)addTreatStyle {
    ...
    [self setAdjustsImageWhenHighlighted:NO];
    [self setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self setBackgroundImage:[self buttonImageFromColor:RGBA(0xf2, 0x96, 0x00, 1)] forState:UIControlStateNormal];
    [self setBackgroundImage:[self buttonImageFromColor:PRESSED_BTN_COLOR] forState:UIControlStateHighlighted];
}
...
-(void)redBoundStyle {
    ...
    self.layer.cornerRadius = 4.0;
    self.layer.masksToBounds = YES;
    self.layer.borderColor = [RGBA(0xff, 0x69, 0x87, 1) CGColor];
    [self setAdjustsImageWhenHighlighted:NO];
}
...
- (void)goodsAttrStyle {
    ...
    self.layer.borderColor = [RGBA(0xf2, 0x27, 0x44, 1) CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:RGBA(0x00, 0x00, 0x00, 0)] forState:UIControlStateNormal];
    [self setBackgroundImage:[self buttonImageFromColor:RGBA(0xf2, 0x27, 0x44, 1)] forState:UIControlStateSelected];
}
...
//    self.layer.cornerRadius = 5.0;
    self.layer.masksToBounds = YES;
    [self setAdjustsImageWhenHighlighted:NO];
    self.layer.borderColor = [RGBA(250, 126, 36, 1) CGColor];
    [self setTitleColor:RGBA(250, 126, 36, 1) forState:UIControlStateNormal];
