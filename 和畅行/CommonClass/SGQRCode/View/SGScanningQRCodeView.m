...
#pragma mark - - - 扫描外部View的创建
    ...
    UIButton *manualBtn = [Tools creatButtonWithFrame:CGRectMake(ScreenWidth/2 - 13 ,light_button.bottom + 30, 60, 50) target:self sel:@selector(rightBarButtonItenAction) tag:31 image:nil title:@"手动输入"];
