...
+(UIView *)createImageWith:(CGFloat)Y{
    ...
    UILabel *instructionLabel = [Tools labelWith:@"您目前还没有数据哦" frame:CGRectMake(0, noMessageImage.frame.origin.y+noMessageImage.frame.size.height+10, kScreenSize.width, 10) textSize:15 textColor:[Tools colorWithHexString:@"#666666"] lines:1 aligment:NSTextAlignmentCenter];
