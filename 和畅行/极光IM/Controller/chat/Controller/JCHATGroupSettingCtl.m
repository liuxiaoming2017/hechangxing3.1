...
- (void)deleteMemberWithPersonView:(JCHATGroupPersonView *)personView {
  ...
  JMSGUser *user = [_groupData objectAtIndex:personView.headViewBtn.tag - 1000];
  [((JMSGGroup *)(self.conversation.target)) removeMembersWithUsernameArray:@[user.username] appKey:@""
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
  if (alertView.tag == 300) {
    ...
    [((JMSGGroup *)(self.conversation.target)) addMembersWithUsernameArray:@[[alertView textFieldAtIndex:0].text] appKey:@""
                                                         completionHandler:^(id resultObject, NSError *error) {
