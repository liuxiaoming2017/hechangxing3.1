...
- (void)createBottomView
{
    ...
    UILabel *label1 = [[UILabel alloc] init];
    label1.frame = CGRectMake(sublayerView.right+Adapter(19),label.bottom+15+Adapter(10),ScreenWidth-sublayerView.right-Adapter(35),Adapter(90));
    
    label1.numberOfLines = 0;
    label1.tag = 222;
    [self.bgScrollView addSubview:label1];
    
    NSString *recommandStr = @"1、Chair doctor will scan for tension and sore muscles\n2、This may take up 4~5 minutes";
